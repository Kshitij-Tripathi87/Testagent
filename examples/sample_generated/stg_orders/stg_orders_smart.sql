{# Auto-generated from DataHub contract by `dhqa generate`
   ...
   Owners: data-team
   Glossary terms: 
   Generated columns: ['id', 'customer_id', 'amount', 'order_ts', 'cleaned_amount']
...
{{ config(
    ...
    schema='staging' if 'stg_orders'.startswith('stg_') else 'marts',
    ...
    columns:
      - name: id
        ...
        data_tests:
          - not_null
          - unique
          - relationships(to=ref('raw_orders'), field='id')
      - name: customer_id
      ...
      - name: order_ts
        ...
        data_tests:
          - not_null
      - name: cleaned_amount
        description: cleaned_amount column
